const lang = {
  sign_up: 'Sign Up',
  manage_your_company_with: 'The Shrewd Steward',
  ...
  it_brings_together_your_invoice_clients_and_leads:
    'It Brings Together Your Investment Clients And Leads',
  ...
  total: 'Total',
  status: 'Status',
  invoices_preview: 'Investments Preview',
  ...
  unpaid: 'Unpaid',
  not_paid: 'Not Paid',
  recent_invoices: 'Recent Investments',
  ...
  accepted: 'Accepted',
  expired: 'Expired',
  new_customer_this_month: 'New Investors This Month',
  active_customer: 'Active Investor',
  overdue: 'Overdue',
  partially: 'Partially',
  paid: 'Paid',
  sign_in: 'Sign In',
  ...
  last_invoice_number: 'Last Investment Number',
  ...
  add_new_person: 'Add New Investor',
  add_new_company: 'Add New Company',
  submit: 'Submit',
  person: 'Investor',
  people_list: 'Investors List',
  firstname: 'Firstname',
  lastname: 'Lastname',
  ...
  convert_to_invoice: 'Convert To Investment',
  subtotal: 'Subtotal',
  address: 'Address',
  update: 'Update',
  expired_date: 'Expired Date',
  created_by: 'Created By',
  invoice_list: 'Investment List',
  add_new_invoice: 'Add New Investment',
  record_payment: 'Record Payment',
  tax_total: 'Tax Total',
  show_invoice: 'Show Investment',
